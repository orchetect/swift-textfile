...
extension TestResource {
    enum TextFiles {
        ...
        static let windows1252_AccentedCharacters_WithUTF8BOM_csv = TestResource.File(
            name: "windows1252-accented-characters-with-utf8-bom",
            ext: "csv",
            subFolder: "Text Files"
        )
    }
